...
public class PutFileMessageSender implements Runnable {
    ...
    public PutFileMessageSender(Peer peer, Message message, int desiredReplicationDegree, int maxIterations) {
        this.peer = peer;
